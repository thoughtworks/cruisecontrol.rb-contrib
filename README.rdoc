...
services, not all of which every 

== Contributing a plugin to this project

If you'd like to contribute a plugin (and we'd love it if you did) we have a contribution[http://cruisecontrolrb.thoughtworks.com/documentation/contributing]
policy[http://cruisecontrolrb.thoughtworks.com/documentation/contributing] outlined in the official product manual.
That having been said, we'd like individual plugin contributors to own and maintain their contributions. If you'd
